...
// let texto = "hola soy camilo y me voy a poner las pilas a pasar el año que es muy facil pero es ponerme hacer las tareas ";
...
setTimeout(() => {
  console.log(document.getSelection().toString()); //selecionar elementos ejemplo con el mause selecionar algo de la pagina                                                                 
}, 2000);
...
// *********************************************
//console.log(document.getElementById("menu")); // se sigue utilizando ya que es mas rapido y sin el . o el #

// nuevos -> consulta de selector y todos los selectores.
// console.log(document.querySelector("#menu")); //(. para clases  y # id)
// // console.log(document.querySelector("a"));
// // console.log(document.querySelectorAll("a"));// trae todo los selectores de este tipo
// // console.log(document.querySelectorAll("a").length);
// // document.querySelectorAll("a").forEach((el) => console.log(el)); //para pintar los a
//  console.log(document.querySelector(".card")); // me trae todos las clases card los elementos
//  console.log(document.querySelectorAll(".card"));
// // console.log(document.querySelectorAll(".card")[2]); // la posición como los array
// // console.log(document.querySelector("#menu li")); // las li que estan en el id menu
...
// console.log(document.documentElement.lang);
// document.documentElement.setAttribute("lang", "es-MX");// setear el atributo el get es traer el atributo
// console.log(document.documentElement.lang);

/* const $linkDOM = document.querySelector(".link-dom"); // $ se coloca para variables que hacen referencia a elementos del DOM
console.log($linkDOM);

$linkDOM.setAttribute("target", "_blank"); 
$linkDOM.setAttribute("rel", "noopener");  */// En resumen, al establecer el atributo rel del elemento $linkDOM en "noopener", se está configurando el enlace para que se abra en una nueva pestaña o ventana del navegador con medidas adicionales de seguridad.
// $linkDOM.setAttribute("href", "https://youtube.com/jonmircha"); // redireccionar cambia el href
...
$eventoSemantico.onclick = holaMundo; semantico es por que se iguala a una función 
...
//puede ser multiples funciones 
$eventoMultiple.addEventListener("click", holaMundo); // cuando sea un listener se coloca la función sin () ya que son los parentesis se ejecuta de una
$eventoMultiple.addEventListener("click", (e) => {
  alert("Hola Mundo Manejador de Eventos Múltiple");
  console.log(e);
  console.log(e.type); evento que lo origino 
  console.log(e.target);
  console.log(event);
});

// como pasar parametros en los eventos 
...
// function flujoEventos(e) {
//  console.log(`Hola te saluda ${this}, el click lo originó ${e.target.className} y me funciona`);
    
//   //e.stopPropagation();
// }
// // La función matches es un método que se utiliza para verificar si un elemento coincide con un selector CSS específico. 
// // Este método retorna true si el elemento coincide con el selector proporcionado, y false si no hay coincidencia.
...
*/
//resize cuando se mueva la ventana es el evento 
...
// window.prompt("Aviso");
// colocar una variable para cada botón
/* const $btnAbrir = document.getElementById("abrir-ventana"),
  $btnCerrar = document.getElementById("cerrar-ventana"),
  $btnImprimir = document.getElementById("imprimir-ventana");

let ventana; // se almacena abrir ventana

$btnAbrir.addEventListener("click",(e) => (ventana = window.open("https://jonmircha.com"))
);

$btnCerrar.addEventListener("click", (e) => {
  //window.close(); // cierra toda la ventana , por eso la variable ventana
  ventana.close();
});

$btnImprimir.addEventListener("click", (e) => window.print()); //imprimir ventana */
/*
...
// console.log(location.origin); // ruta que se origina
// console.log(location.protocol); //
// console.log(location.host);
// console.log(location.hostname);
// console.log(location.port);
// console.log(location.href);
// console.log(location.hash); // trae la cadena despues de #
// console.log(location.search); // trae la cadena despues de ?
